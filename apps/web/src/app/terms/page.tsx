        ...
        <section className="mx-auto max-w-[860px] px-5 py-[52px] md:px-[32px]">
          ...
          <div className="border border-[rgba(184,68,68,0.35)] bg-[rgba(184,68,68,0.06)] px-[20px] py-[18px] mb-[48px]">
            ...
            <p className="font-bask text-[13px] text-ink2 leading-[1.8]">
              ...
              <strong className="text-ink">not</strong> a medical provider and
              does not offer medical advice, diagnosis, or clinical treatment of
              any kind. Consult a licensed clinician before beginning any new
              training programme.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-[48px]">
            ...
            <section id="agreement">
              ...
              <P>
                ...
                training programme generation service (the &ldquo;Service&rdquo;).
              </P>
              <P>
                By accessing the Service, submitting the assessment, or
                generating a training programme, you confirm that you have read,
            ...
            <section id="not-medical">
              ...
              <P>
                ...
                programmes generated by the Service are produced by an automated
            ...
            <section id="service">
              ...
              <P>
                ...
                generates a weekly strength and conditioning programme governed by
            ...
            <section id="responsibilities">
              ...
              <ul className="flex flex-col gap-[8px] border border-line bg-bg1 px-[20px] py-[18px]">
                {[
                  "Provide accurate, current, and complete information in the assessment. Programme quality depends entirely on accurate inputs.",
                  ...
                  "Not submit false health information to obtain a programme that misrepresents your physical state.",
            ...
            <section id="ip">
              ...
              <P>
                ...
                (Dispatches), design system, and programme output structure — is
                the intellectual property of Riz Management LLC, protected by
                copyright and applicable law.
              </P>
              <P>
                The personalised training programme generated for you is provided
                for your personal, non-commercial use. You may not redistribute,
                resell, or sublicense programme outputs without express written
                permission.
              </P>
              <P>
