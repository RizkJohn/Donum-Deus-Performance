...
export const metadata: Metadata = {
  title: "Terms of Service — Donum Dei Performance",
  description:
    "Terms governing use of Donum Dei Performance — the adaptive training engine operated by Riz Management LLC.",
};
        ...
        <section className="mx-auto max-w-[860px] px-5 py-[52px] md:px-[32px]">
          ...
          <div className="border border-[rgba(184,68,68,0.35)] bg-[rgba(184,68,68,0.06)] px-[20px] py-[18px] mb-[48px]">
            ...
            <p className="font-bask text-[13px] text-ink2 leading-[1.8]">
              Donum Dei Performance is a practice of performance education. It is
          ...
          <div className="flex flex-col gap-[48px]">
            ...
            <section id="agreement">
              ...
              <P>
                ...
                (&ldquo;Donum Dei Performance,&rdquo; &ldquo;we,&rdquo;
                &ldquo;us,&rdquo; &ldquo;our&rdquo;) governing your access to
                and use of the website at donumdeiperformance.com and the associated
            ...
            <section id="not-medical">
              ...
              <P>
                Donum Dei Performance is a practice of performance education. Training
            ...
            <section id="service">
              ...
              <P>
                Donum Dei Performance provides a free automated assessment that collects
            ...
            <section id="ip">
              ...
              <P>
                All content on the Donum Dei Performance website — including the engine
            ...
            <section id="contact">
              ...
              <div className="border border-line bg-bg1 px-[20px] py-[18px] mb-[16px]">
                {[
                  ["Legal contact", "Riz Management LLC · Donum Dei Performance"],
                  ["Email", "legal@donumdeiperformance.com"],
                ].map(([label, value]) => (
